...
cls
echo =================================================
echo   WIRELESS SCRCPV ALL IN ONE 
echo =================================================
echo.
echo MAIN MENU:
echo.
...
echo.
echo   --- PREPARATION AND TOOLS ---
echo    4. Activate ADB via USB (Classic Method, All Android)
echo    5. Wireless Debugging Helper (Android 11+ Only)
echo    6. Manage IP List
echo.
echo   --- OTHER ---
echo    7. Exit
echo.
...
if "%CHOICE%"=="4" goto ActivateClassicADB
if "%CHOICE%"=="5" goto WirelessDebuggingHelper
if "%CHOICE%"=="6" goto ManageIPs
if "%CHOICE%"=="7" exit /b
goto MainMenu
...
if %count% equ 0 (
    ...
    echo Make sure you have performed one of the ADB activation methods.
    pause
    goto MainMenu
)
...
rem --- Tool: Classic ADB Activation ---
:ActivateClassicADB
cls
echo =================================================
echo   Activate ADB via USB (Classic Method)
echo =================================================
echo.
echo ATTENTION:
echo This step needs to be repeated every time your phone is restarted.
echo.
echo 1. Connect your phone to this computer using a USB cable.
...
rem --- ERROR CHECKING: Capture the output and check for keywords ---
set "adb_output="
for /f "delims=" %%a in ('adb.exe tcpip 5555 2^>^&1') do (
    set "adb_output=%%a"
    echo   %%a
)
...
echo.
echo -------------------------------------------------
if "!adb_output:restarting=!" NEQ "!adb_output!" (
    echo SUCCESS! Port 5555 is now open.
    echo You can now unplug the USB cable and return to the main menu to scan.
) else (
    echo ERROR! The command failed.
    echo Make sure the phone is properly connected and debugging has been authorized.
)
echo -------------------------------------------------
echo.
pause
...
rem --- Tool: Wireless Debugging Helper (Android 11+) ---
:WirelessDebuggingHelper
cls
echo =================================================
echo   Wireless Debugging Helper (Android 11+ Only)
echo =================================================
echo.
echo Use this tool to connect without any USB cable at all.
echo.
...
echo.
set "WD_CHOICE="
set /p WD_CHOICE="--> Enter your choice (1-3): "
if "%WD_CHOICE%"=="1" goto PairDevice
if "%WD_CHOICE%"=="2" goto ConnectDevice
if "%WD_CHOICE%"=="3" goto MainMenu
goto WirelessDebuggingHelper
...
if not defined PAIR_IP_PORT goto WirelessDebuggingHelper
echo.
set /p PAIR_CODE="--> Enter the 6-digit Wi-Fi pairing code: "
if not defined PAIR_CODE goto WirelessDebuggingHelper
echo.
echo Executing pairing command...
adb.exe pair %PAIR_IP_PORT% %PAIR_CODE%
echo.
echo ---
...
if not defined CONN_IP_PORT goto WirelessDebuggingHelper
echo.
echo Attempting to connect...
adb.exe connect %CONN_IP_PORT%
echo.
echo ---
echo Connection process finished. Return to the main menu to scan or connect.
echo ---
echo.
pause
goto MainMenu
